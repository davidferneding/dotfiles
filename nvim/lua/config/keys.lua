...
bind({ 'i', 'n' }, '<C-1>', cmd(':HarpoonSwitch 1'), { desc = 'jump to harpoon buffer 1' })
bind({ 'i', 'n' }, '<C-2>', cmd(':HarpoonSwitch 2'), { desc = 'jump to harpoon buffer 2' })
bind({ 'i', 'n' }, '<C-3>', cmd(':HarpoonSwitch 3'), { desc = 'jump to harpoon buffer 3' })
bind({ 'i', 'n' }, '<C-4>', cmd(':HarpoonSwitch 4'), { desc = 'jump to harpoon buffer 4' })
bind({ 'i', 'n' }, '<C-5>', cmd(':HarpoonSwitch 5'), { desc = 'jump to harpoon buffer 5' })
bind({ 'i', 'n' }, '<C-6>', cmd(':HarpoonSwitch 6'), { desc = 'jump to harpoon buffer 6' })
bind({ 'i', 'n' }, '<C-7>', cmd(':HarpoonSwitch 7'), { desc = 'jump to harpoon buffer 7' })
bind({ 'i', 'n' }, '<C-8>', cmd(':HarpoonSwitch 8'), { desc = 'jump to harpoon buffer 8' })
bind({ 'i', 'n' }, '<C-9>', cmd(':HarpoonSwitch 9'), { desc = 'jump to harpoon buffer 9' })
