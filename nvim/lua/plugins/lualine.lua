...
local function _1_()
  ...
  local config = {options = {component_separators = "\194\183", section_separators = "", theme = {normal = {c = {fg = colors.text, bg = colors.base}}, inactive = {c = {fg = colors.text, bg = colors.base}}}}, sections = {lualine_a = {}, lualine_b = {}, lualine_y = {}, lualine_z = {}, lualine_c = {}, lualine_x = {}}, inactive_sections = {lualine_a = {}, lualine_b = {}, lualine_y = {}, lualine_z = {}, lualine_c = {}, lualine_x = {}}}
  ...
  insert_right({_14_, color = {fg = colors.pink, gui = "bold"}})
...
return {"nvim-lualine/lualine.nvim", dependencies = {"nvim-mini/mini.icons"}, config = _1_}
